    ...
    <>
      <Overlay open={dialog} backdrop={<OverlayBackdrop />}>
        <OverlayCenter>
          ...
          >
            <Dialog variant="Surface" role="dialog" aria-modal="true" aria-labelledby="add-server-dialog-title">
              <Header
                style={{
              ...
              >
                <Box grow="Yes">
                  <Text size="H4" as="h2" id="add-server-dialog-title">Add Server</Text>
                </Box>
